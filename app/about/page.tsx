      ...
      <section className="py-14 bg-gray-50">
        <div className="container max-w-3xl text-center">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            {[
              { title: "Имэйл", value: "nextstep@gmail.com", icon: <FiMail />},
              { title: "Instagram", value: "just_graduated.mn", icon: <FaInstagram />},
              { title: "Facebook", value: "YOUR Next step",  icon: <FaFacebook />},
            ].map((item) => (
              <div
                key={item.title}
                className="bg-white p-6 rounded-xl shadow"
              >
                <p className="font-semibold text-[#ff673d]">{item.title}</p>
